...
namespace Snake
{
    ...
    void Controller::receive(std::unique_ptr<Event> e)
    {
        try
        {
            ...
            auto NewHeadPair = std::make_pair(newHead.x, newHead.y);

            bool lost = false;

            for (auto segment : m_segments)
            {
                if (NewHeadPair == std::make_pair(segment.x, segment.y))
                {
            ...
            if (not lost)
            {
                ...
                placeNewHead.x = NewHeadPair.first;
                placeNewHead.y = NewHeadPair.second;
    ...
    template <typename someStruct>
    void Controller::foodColide(someStruct str, bool oldFoodClear)
    {
        auto Food = str;
